const productos = [
    ...
    },
    {
        ...
        descripcion: 'Camisa con corazones bordados',
        precio: 29.99,
        stock: 25
    },
    {
    ...
    },
    {
        ...
        descripcion: 'Jersey de color gris con puños y dobladillo acabados en canalé. Cuello redondo y manga larga, detalle de perritos bordados.',
        precio: 49.99,
        stock: 50
    },
    {
        ...
        descripcion: 'Jersey de color beige con puños y dobladillo acabados en canalé. Cuello redondo y manga larga, detalle de perritos bordados.',
        precio: 49.99,
        stock: 50
    },
    {
        ...
        descripcion: 'Jersey amplio de cuello vuelto y manga larga abullonada con corazones burdeos.',
        precio: 39.99,
        stock: 50
    },
    {
        ...
        descripcion: 'Jersey oversize con rayas teja y doradas. Hombros caido y fondo en color beige.',
        precio: 33.99,
        stock: 50
    },
    {
        ...
        descripcion: 'Blusa tipo top de encaje con transparencias. Cuello perkins y color negro.',
        precio: 14.99,
        stock: 50
    },
    {
    ...
    },
    {
        ...
        descripcion: 'Chaqueta de corte holgado en borreguito suave con cierre de botones.',
        precio: 49.99,
        stock: 50
    },
    {
    ...
    },
    {
        ...
        descripcion: 'Jersey de punto. Manga larga, una ligera hombrera. Cuello tipo polo. Acabados en rib. Prenda ligera.',
        precio: 29.99,
        stock: 50
    },
    {
    ...
    {
        id: 20,
        nombre: 'Cárdigan rosa corazones gris',
        imagen: 'https://mardemarbarcelona.com/cdn/shop/files/bolso-granate-asa-extrahible-3_900x.jpg',
        descripcion: 'Cárdigan confeccionado con tejido de punto en mezcla de lana. Cuello redondo.',
        precio: 39.99,
        stock: 50
    },
    {
        id: 21,
        nombre: 'Cárdigan rosa corazones rosa',
    ...
    },
    {
        ...
        descripcion: 'Camisa verde básica',
        precio: 19.99,
        stock: 50
    },
    {
    ...
    },
    {
        ...
        descripcion: 'Camiseta slim tipo Top cropped corto de canalé con rayas horizontales negras.',
        precio: 24.99,
        stock: 50
    },
    {
        ...
        descripcion: 'Camiseta confeccionada en hilatura de algodón 100%. Escote redondo y manga corta. Acabados en puntilla.',
        precio: 19.99,
        stock: 50
    },
    {
